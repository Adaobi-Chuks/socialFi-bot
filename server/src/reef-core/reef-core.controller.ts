...
export class ReefCoreController {
    ...
    async test(@Query('pk') pk: string) {
        ...
        try {
            const balance = await this.reefCoreService.getBalance("0xD81e692C35b480Be9E237Ac9E13828656619C8B6");
            const send = await this.reefCoreService.send(pk, "0xD81e692C35b480Be9E237Ac9E13828656619C8B6", '2');
            const estimateFee = await this.reefCoreService.estimateFee(pk, "0xD81e692C35b480Be9E237Ac9E13828656619C8B6", '2');
            return {
                balance,
                send,
                estimateFee
